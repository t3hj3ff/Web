            ...
            <div class="render">
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="item-layout">
                        <span class="@if($layout == 'grid') active @endif" data-layout="grid"><i class="ti-layout-grid2"></i></span>
                        <span class="@if($layout == 'list') active @endif" data-layout="list"><i class="ti-view-list-alt"></i></span>
                    </div>
                </div>
