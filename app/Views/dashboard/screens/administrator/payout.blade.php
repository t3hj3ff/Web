                        ...
                        <th data-priority="2" class="text-center">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownFilterStatus">
                                    ...
                                    <a class="dropdown-item" href="{{ add_query_arg('status', 'pending') }}">{{__('Pending')}}</a>
                                    <a class="dropdown-item" href="{{ add_query_arg('status', 'completed') }}">{{__('Completed')}}</a>
                                </div>
                        ...
                        @foreach ($allPayouts['results'] as $item)
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    ...
                                    ?>
                                    <span class="booking-status booking-bgr {{$item->status}}"><span class="exp">{{$payout_status['name']}}</span></span>
                                </td>
                                <td class="align-middle">
