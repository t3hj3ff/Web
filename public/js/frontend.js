...
(function ($) {
    ...
    $(document).on("click", ".search-next-step", function(){
        let maxStep = 4;
        let curstep = $(".search-mob-step.active").data("step");
        $(".search-mob-step").removeClass("active");
        curstep = curstep + 1 > maxStep ? maxStep - 1: curstep;
        $(`.search-mob-step[data-step="${curstep + 1}"]`).addClass("active");
    })
})(jQuery);
