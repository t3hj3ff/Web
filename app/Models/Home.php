...
class Home extends Model
{
    ...
    protected $homeRooms = 'home_rooms';
    protected $homeFeatures = 'home_features';
    protected $homePrices = 'home_price';
    protected $homeRates = 'home_rates';


    public function getFeatures($home_id)
  	{
  		return DB::table('home_features')->select('*')->where('home_id', $home_id)->first();
  	}
    public function getRooms($home_id)
  	{
  		return DB::table('home_rooms')->select('*')->where('home_id', $home_id)->first();
  	}
    public function getRoomsinner($home_id)
  	{
  		return DB::table('home_rooms')->select('*')->where('home_id',$home_id)->get();
  	}
    ...
    // public function getById1($home_id)
    // {
    //     $post = DB::table($this->homeRooms)->where('home_id', $home_id)->get()->first();
    //     return (!empty($post) && is_object($post)) ? $post : null;
    // }
    //
    // public function getById2($home_id)
    // {
    //     $post = DB::table($this->homeFeatures)->where('home_id', $home_id)->get()->first();
    //     return (!empty($post) && is_object($post)) ? $post : null;
    // }
    ...
    public function deleteHomeItem($home_id)
    {
        ...
        DB::table('term_relation')->where('service_id', $home_id)->delete();
