...
<div class="{{$class_wrapper}}">
    <div class="hh-service-item car grid" data-plugin="matchHeight" data-lng="{{ $item->location_lng }}" data-lat="{{ $item->location_lat }}" data-id="{{ $item->post_id }}">
        <a href="{{ get_car_permalink($item->post_id, $item->post_slug) }}">
            <div class="thumbnail">
        ...
        <div class="detail">
            ...
            <h2 class="title text-overflow"><a
                    href="{{ get_car_permalink($item->post_id, $item->post_slug) }}">{{ get_translate($item->post_title) }}</a></h2>
