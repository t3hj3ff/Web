                ...
                <div class="modal-body relative">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control has-validation {{get_lang_class($key, $item)}}"
                               data-validation="required" id="term_name{{get_lang_suffix($item)}}" name="term_name{{get_lang_suffix($item)}}"
                    ...
                    <div class="form-group">
                        ...
                        @foreach($langs as $key => $item)
                        <textarea name="term_description{{get_lang_suffix($item)}}" id="term_description{{get_lang_suffix($item)}}" class="form-control {{get_lang_class($key, $item)}}"
                                  placeholder="{{__('Description')}}" @if(!empty($item)) data-lang="{{$item}}" @endif></textarea>
                        @endforeach
                    </div>
                    <div class="form-group">
                        <label for="term_type">
                        ...
                        <div class="hh-upload-wrapper clearfix">
                            ...
                            <div class="mt-1">
                                ...
                                <input id="term_image" type="hidden" class="upload_value input-upload" value="" name="term_image"
