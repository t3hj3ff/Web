...
<link rel="stylesheet" href="http://192.168.100.9/veyvey/public/css/product-page-style.css">
<link rel="stylesheet" href="http://192.168.100.9/veyvey/public/css/style-prod.css">
<body>
<header class="product-header-section">
            ...
            <div class="product-header-wrapper">
                <div class="profile-header">
                    <div class="profile-logo">
                        <a href="http://test.gtrun.ge/home">
                            <div class="logo">
                    ...
                    <nav class="main-nav">
                        <ul>
                            <li>
                                <div class="language">
                                    <img src="image/united-states.png" alt="">
                                    <img src="image/dolar-sign.png" alt="">
                                    <img src="image/drop-down-arrow.png" alt="">
                ...
                <div class="product-page-header">
                    <ul class="alt-header">
                        <li class="overview-button" onclick="scrollToOverview()">Overview</li>
                        <li class="amenities-button" onclick="scrollToAmenities()">Amenities</li>
                        <li class="options-button" onclick="scrollToOptions()">Room Options</li>
                        <li class="location-button" onclick="scrollToLocation()">Location</li>
                    </ul>
                    <div class="product-page-header-price-detals">
                        <div class="product-page-header-price">
                            <div class="sale-block">
                                -10%
                            </div>
                            <div class="price-block">
                                <span class="from">$2,50</span>
                                <span class="current">$150</span>
                            </div>
                            <div class="price-detals">
                                    <button>
                                        <span>Price details</span>
                                        <img src="image/Stroke-small.png" alt="">
                                    </button>
                                    <div class="price-detals-popup uk-drop uk-drop-bottom-left" uk-drop="mode: click" style="left: 0px; top: 21px;">
                        ...
                        <div class="product-page-header-price-button">
                            <button>
                                Reserve
                            </button>
                        </div>
        ...
        <div class="product-page-slider">
            <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1" uk-slider>
                <ul class="uk-slider-items uk-child-width-1-3">
                    <li>
                        <img src="http://192.168.100.9/veyvey/images/hotel-img1.png" alt="">
                    </li>
                    <li>
                        <img src="http://192.168.100.9/veyvey/images/hotel-img2.png" alt="" active>
                    </li>
                    <li>
                        <img src="http://192.168.100.9/veyvey/images/hotel-img3.png" alt="">
                    </li>
                    <li>
                        <img src="http://192.168.100.9/veyvey/images/hotel-img3.png" alt="">
                    </li>
                    <li>
                        <img src="http://192.168.100.9/veyvey/images/hotel-img4.png" alt="">
                    </li>
                </ul>
                <a class="uk-position-center-left uk-position-small slider-arrow-left slider-arrow" href="#" uk-slidenav-previous uk-slider-item="previous">
                    <img src="http://192.168.100.9/veyvey/images/slider-arrow-left.png" alt="">
                </a>
                <a class="uk-position-center-right uk-position-small slider-arrow-right slider-arrow" href="#" uk-slidenav-next uk-slider-item="next">
                    <img src="http://192.168.100.9/veyvey/images/slider-arrow-right.png" alt="">
                </a>
                <div class="product-page-slider-button">
                    <div class="profile-container">
                        <div class="slider-button-block">
                            <button class="tour">
                                <img src="http://192.168.100.9/veyvey/images/3Drotation.png" alt="">
                                3D Tour
                            </button>
                            <button class="all-photo">
                                <img src="http://192.168.100.9/veyvey/images/image-icon.png" alt="">
                                All photos +15
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="product-page-description">
                        ...
                        <div class="product-page-description-block">
                            ...
                            <button class="translate-button">
                                <img src="http://192.168.100.9/veyvey/images/google-translate.png" alt="">
                                Google Translate
                            </button>
                        </div>
                    </div>
                                            ...
                                            <div class="price-detals">
                                                ...
                                                <div class="price-detals-popup" uk-drop="mode: click">
                                                    <div class="price-detals-title">
                                                        <h4>Price Details</h4>
                                                        <button class="uk-drop-close uk-right-top" type="button">
                                                            <img src="http://192.168.100.9/veyvey/images/close.png" alt="">
                                                        </button>
                                                    </div>
                                                    <div class="price-detals-list">
                                                        <ul>
                                ...
                                <div id="my-id" class="prouct-page-modal" uk-modal>
                                    <div class="uk-modal-dialog uk-modal-body">
                                        <div class="prouct-page-price-modal">
                                            ...
                                            <div class="price-modal-header-mobile">
                                                <button class="uk-modal-close">
                                                    <img src="http://192.168.100.9/veyvey/public/images/svg/modal-back-tablet.svg" alt="">
                                                    Back to Rooms
                                                </button>
                                            </div>
                                                ...
                                                <div class="profile-container">
                                                    <div class="price-modal-wrapper">
                                                            ...
                                                            <div class="price-modal-slider">
                                                                <div class="uk-position-relative uk-visible-toggle uk-light" tabindex="-1" uk-slider>
                                                                    <ul class="uk-slider-items uk-child-width-1-1">
                                                                        ...
                                                                        <li>
                                                                            <img src="http://192.168.100.9/veyvey/images/hotel-img2.png" alt="">
                                                                        </li>
                                                                        <li>
                                                                            <img src="http://192.168.100.9/veyvey/images/hotel-img3.png" alt="">
                                                                        </li>
                                                                    ...
                                                                    <ul class="uk-slider-nav uk-dotnav uk-flex-center uk-margin slidet-dots"></ul>
                                                                </div>
                                                            </div>
                                                            <div class="price-modal-sidebar-room-info modal-room-info-tablet">
                                                        ...
                                                        <div class="price-modal-sidebar">
                                                                ...
                                                                <div class="amenities-list-wrapper">
                                                                    <div class="amenities-list">
                                                                        <div class="amenities-list-title">
                                                                            <img src="http://192.168.100.9/veyvey/images/Search.png" alt="">
                                                                            <h4>Entire Home</h4>
                                                                        </div>
                                                                        <ul>
                                                                    ...
                                                                    <div class="amenities-list">
                                                                        <div class="amenities-list-title">
                                                                            <img src="http://192.168.100.9/veyvey/images/Scan.png" alt="">
                                                                            <h4>Bathroom</h4>
                                                                        </div>
                                                                        <ul>
                                                                            <li class="amenities-pricey">
                                                                    ...
                                                                    <div class="amenities-list">
                                                                        <div class="amenities-list-title">
                                                                            <img src="http://192.168.100.9/veyvey/images/discovery.png" alt="">
                                                                            <h4>Bathroom</h4>
                                                                        </div>
                                                                        <ul>
                                                                            <li class="amenities-pricey">
                                                                    ...
                                                                    <div class="amenities-list">
                                                                        <div class="amenities-list-title">
                                                                            <img src="http://192.168.100.9/veyvey/images/Folder.png" alt="">
                                                                            <h4>House Rules</h4>
                                                                        </div>
                                                                        <ul>
                                                                            <li class="amenities-pricey">
                                                            ...
                                                            <div class="price-modal-sidebar-wrapper">
                ...
                <div class="product-page-sidebar">
                    <div class="hotel-shear-bock">
                        <div class="hotel-shear-wrapper">
                            ...
                            <button class="hart">
                                <img src="http://192.168.100.9/veyvey/images/heart.png" alt="">
                            </button>
                        </div>
                    </div>
                    <div class="product-page-price-wrapper">
                        <div class="product-page-price-block form-book-1" id="form-book-home" data-real-price="{{ url('get-home-price-realtime') }}" style="position: sticky !important; top: 174px !important;">
                            <div class="product-page-price-block-header">
                                <div class="price-block-header">
                                    <div class="product-page-hotel-logo">
                                        <img src="http://192.168.100.9/veyvey/images/hotel-logo1.png" alt="">
                                    </div>
        ...
        .product-page-price-block {
            ...
            inset: 174px 0 0 0 !important;
                                                ...
                                                <form class="form-action" action="{{ url('add-to-cart-home') }}" method="post"
                                                    ...
                                                    @if($post->booking_type == 'per_night')
                                                        <div class="form-group">
                                                            <div style="padding: 14px 24px; display: flex; align-items: center; margin: 24px 16px 0; background: #FFFFFF;border: 1px solid #F0F1F3;box-sizing: border-box;border-radius: 16px; width: auto;" class="date-wrapper date-double"
                                                                ...
                                                                <div style="width: 96px;">
                                                                    <span style="color: rgba(13, 13, 13, 0.75); font-size: 14px; letter-spacing: -0.078px; display: flex;">From</span>
                                                                    <span style="font-weight: bold;font-size: 16px;color: #040921; width: 100%; padding: 0;" class="check-in-render"
                                                                      data-date-format="{{ hh_date_format_moment() }}"></span>
                                                                </div>
                                                                <div style="margin: 0 16px;">
                                                                <img src="http://192.168.100.9/veyvey/images/arrow-right.png" alt="">
                                                                </div>
                                                                <div style="width: 96px;">
                                                                    <span style="color: rgba(13, 13, 13, 0.75); font-size: 14px; letter-spacing: -0.078px; display: flex;">Until</span>
                                                                    <span style="font-weight: bold;font-size: 16px;color: #040921; width: 100%; padding: 0;" class="check-out-render"
                                                                      data-date-format="{{ hh_date_format_moment() }}"></span>
                                                                </div>
                                                                <div style="flex: 1; display: flex; justify-content: flex-end;">
                                                                    <div style="border: 1px solid rgba(0, 0, 0, 0.08); border-radius: 555px; width: 36px; height: 36px; display: flex; justify-content: center; align-items: center;">
                                                                        <img src="http://192.168.100.9/veyvey/images/Calendar2.png" alt="">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @elseif($post->booking_type == 'per_hour')
                                                        <div class="form-group">
                                                            ...
                                                            <div class="date-wrapper date-single input-block-sidebar"
                                                                 data-date-format="{{ hh_date_format_moment() }}"
                                                                ...
                                                                <input type="text" class="input-hidden check-out-field"
                                                                       name="checkOut">
                                                                <div style="width: 96px;">
                                                                    <span style="color: rgba(13, 13, 13, 0.75); font-size: 14px; letter-spacing: -0.078px; display: flex;">Guests</span>
                                                                    <span class="check-in-render"
                                                                        style="font-weight: bold;font-size: 16px;color: #040921; width: 100%; padding: 0;"
                                                                        data-date-format="{{ hh_date_format_moment() }}"></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group" style="margin-bottom: 0;">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="positon: relative;">
                                                                <button style="padding: 14px 24px; display: flex; color: #040921;font-weight: bold;font-size: 16px;background: #FFFFFF;border: 1px solid #F0F1F3;box-sizing: border-box;border-radius: 16px; height: 68px; width: 368px; margin: 0 16px; align-items: flex-end;" type="button" class="btn btn-light dropdown-toggle"
                                                                ...
                                                                <div style="flex: 1; display: flex; justify-content: flex-end; position: absolute; top: 16px; right: 40px;">
                                                                    <div style="border: 1px solid rgba(0, 0, 0, 0.08); border-radius: 555px; width: 36px; height: 36px; display: flex; justify-content: center; align-items: center;">
                                                                            <img src="http://192.168.100.9/veyvey/images/add-user.png" alt="">
                                                                    </div>
                                                                </div>
                                                                <span style="position: absolute; top: 10px; left: 40px; color: rgba(13, 13, 13, 0.75); font-size: 14px; letter-spacing: -0.078px; display: flex;">
                                                                Guests
                                                                </span>
                                                            </div>
                                                    ...
                                                    <div class="product-page-price-block-body">
                                                      <div class="price-block-info-wrapper">
                                                        ...
                                                        <button class="info-block">
                                                            ...
                                                            <div class="info-block-button">
                                                                <div class="info-block-icon">
                                                                    <img src="http://192.168.100.9/veyvey/images/small-home.png" alt="">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <button class="info-block">
                                                                ...
                                                                <div class="info-block-button">
                                                                    <div class="info-block-icon">
                                                                        <img src="http://192.168.100.9/veyvey/images/arrow-down-small-product.png" alt="">
                                                                    </div>
                                                                </div>
                                                                <div uk-drop="mode: click" class="info-block-dropdown">
                                                                    <ul>
                                                    ...
                                                    <div class="form-group form-render test">
                                                    </div>
                                                    <div class="form-group mt-2" style="display: flex; justify-content: center;">
                    ...
                    <div class="free-cancellation">
                            <img src="http://192.168.100.9/veyvey/images/Password.png" alt="">
    ...
    <section class="options-section">
        <div class="profile-container">
            <div class="product-page-experience">
                <h2>Experience</h2>
                <div uk-slider>
                    <ul class="uk-slider-items product-page-experience-wrapper">
                        <li>
                            <div class="product-page-experience-block">
                                <div class="experience-image">
                                    <img src="http://192.168.100.9/veyvey/images/hotel-img5.png" alt="">
                                </div>
                        ...
                        <li>
                            <div class="product-page-experience-block">
                                <div class="experience-image">
                                    <img src="http://192.168.100.9/veyvey/images/hotel-img6.png" alt="">
                                </div>
                        ...
                        <li>
                            <div class="product-page-experience-block">
                                <div class="experience-image">
                                    <img src="http://192.168.100.9/veyvey/images/hotel-img7.png" alt="">
                                </div>
                                <h3>Iveria Cafe</h3>
                                <div class="cuisine">
                                    <h5>Cuisine:</h5>
                        ...
                        <li>
                            <div class="product-page-experience-block">
                                <div class="experience-image">
                                    <img src="http://192.168.100.9/veyvey/images/hotel-img8.png" alt="">
                                </div>
                                <h3>Iveria Cafe</h3>
                                <div class="cuisine">
                                    <h5>Cuisine:</h5>
        ...
        <div class="profile-container">
            <div class="product-page-location">
                ...
                <div class="product-page-location-map">
                    <img src="http://192.168.100.9/veyvey/images/map.png" alt="">
                </div>
            </div>
            <div class="property-surroundings">
                ...
                <div class="property-surroundings-wrapper">
                    <div class="property-surroundings-block">
                        <div class="property-surroundings-header">
                            <div class="property-surroundings-title">
                                <img src="http://192.168.100.9/veyvey/images/star-icon.png" alt="">
                                <h3>What’s nearby</h3>
                            </div>
                    ...
                    <div class="property-surroundings-block">
                        <div class="property-surroundings-header">
                            <div class="property-surroundings-title">
                                <img src="http://192.168.100.9/veyvey/images/vertalioti.png" alt="">
                ...
                <div class="things-to-know-wrapper">
                        ...
                        <ul>
                            <li>
                                <div class="things-to-know-list-icon">
                                    <img src="http://192.168.100.9/veyvey/images/Info-circle.png" alt="">
                                </div>
                    ...
                    <div class="things-to-know-list">
                        ...
                        <ul>
                            <li>
                                <div class="things-to-know-list-icon">
                                    <img src="http://192.168.100.9/veyvey/http://192.168.100.9/veyvey/images/Info-circle.png" alt="">
                                </div>
                                <span>Check-in: After 4:00 PM</span>
                            </li>
                            <li>
                                <div class="things-to-know-list-icon">
                                    <img src="http://192.168.100.9/veyvey/http://192.168.100.9/veyvey/images/Users.png" alt="">
                                </div>
                ...
                <div class="reviews-wrapper">
                    <div class="review-points">
                        <ul>
                            <li>
                                <a href="@">
                                    <img src="http://192.168.100.9/veyvey/images/Wallet.png" alt="">
                                    Cleanliness
                                </a>
                                <span>5.0</span>
                            </li>
                            ...
                            <li>
                                <a href="@">
                                    <img src="http://192.168.100.9/veyvey/images/Calendar.png" alt="">
                                    Accuracy
                                </a>
                                <span>5.0</span>
                            </li>
                            <li>
                                <a href="@">
                                    <img src="http://192.168.100.9/veyvey/images/Activity.png" alt="">
                                    Location
                                </a>
                                <span>4.7</span>
                            </li>
                        ...
                        <div class="comment">
                            <div class="comment-author">
                                <div class="comment-author-image">
                                    <img src="http://192.168.100.9/veyvey/images/sergio.png" alt="">
                                </div>
        ...
        <div class="profile-container">
            <div class="faq">
                ...
                <div class="faq-wrapper uk-accordion" uk-accordion="multiple: true">
                    ...
                    <div class="faq-block">
                        <a class="uk-accordion-title" href="#"> So I get full service AND a commission</a>
                        <div class="uk-accordion-content faq-block-text" hidden="">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    </div>
                    <div class="faq-block">
                        <a class="uk-accordion-title" href="#" aria-expanded="false">Get full  When and how do I get my</a>
                        <div class="uk-accordion-content faq-block-text" hidden="">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                    </div>
    ...
    <section>
        <div class="profile-container">
            <div class="also-like">
                ...
                <div uk-slider>
                    <ul class="uk-slider-items also-like-wrapper">
                        <li>
                            <div class="also-like-block">
                                ...
                                <div class="also-like-hotel-price-info">
                                    <div class="also-like-hotel-rating">
                                        <img src="http://192.168.100.9/veyvey/images/Star-rating.png" alt="">
                                        <span>4.8</span>
    ...
    <div class="mobile-sticky">
        <div class="sticky-menu-wrapper">
            <a href="">
                <img src="http://192.168.100.9/veyvey/public/images/svg/purple-search.svg" alt="">
            </a>
            <a href="">
                <img src="http://192.168.100.9/veyvey/public/images/svg/fav.svg" alt="">
            </a>
            <a href="">
                <img src="http://192.168.100.9/veyvey/public/images/svg/message.svg" alt="">
                <span class="new-message"></span>
            </a>
            <a href="">
                <img src="http://192.168.100.9/veyvey/public/images/svg/profile.svg" alt="">
            </a>
        </div>
    </div>
</body>
...
<script src="http://192.168.100.9/veyvey/public/js/product-main.js"></script>
