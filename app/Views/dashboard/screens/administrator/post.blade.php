        ...
        <div class="content">
            ...
            <div class="card-box">
                ...
                <div class="action-toolbar">
                    <form class="hh-form form-inline" action="{{dashboard_url('post-bulk-actions')}}" data-target="#table-my-post" method="post">
                ...
                <table id="table-my-post" class="table table-large mb-0 dt-responsive nowrap w-100 hh-list-service" data-plugin="datatable"
                       data-paging="false"
                       data-ordering="false">
                    <thead>
                    <tr>
                        ...
                        <th data-priority="-1" class="hh-checkbox-td">
                            <div class="checkbox checkbox-success hh-check-all">
                                ...
                                <label for="hh-checkbox-all--my-post"><span class="d-none">{{__('Check All')}}</span></label>
                            </div>
                        </th>
                        <th data-priority="-1">
                            {{__('Name')}}
