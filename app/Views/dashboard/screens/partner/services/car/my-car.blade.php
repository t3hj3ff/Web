        ...
        <div class="content">
            ...
            <div class="card-box">
                ...
                <div class="action-toolbar">
                    <form class="hh-form form-inline" action="{{dashboard_url('car-bulk-actions')}}" data-target="#table-my-car" method="post">
                ...
                <table id="table-my-car" class="table table-large mb-0 dt-responsive nowrap w-100" data-plugin="datatable"
                       data-paging="false"
                       data-export="on"
                    ...
                    <tr>
                        ...
                        <th data-priority="-1" class="hh-checkbox-td">
                            <div class="checkbox checkbox-success hh-check-all">
                                ...
                                <label for="hh-checkbox-all--my-car"><span class="d-none">{{__('Check All')}}</span></label>
                            </div>
                        </th>
                        <th data-priority="1">
                                ...
                                <td class="align-middle">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h5 class="m-0"><a href="{{ get_car_permalink($carID, $item->post_slug) }}"
                                                               target="_blank">{{ get_translate($item->post_title) }}</a>
                                                <span class="text-muted"> - {{ $carID }}</span>
                                            </h5>
                                            <span class="exp d-none">[{{ $carID }}] {{ get_translate($item->post_title) }}</span>
