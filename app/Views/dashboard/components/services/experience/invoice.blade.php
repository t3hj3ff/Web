...
<div class="tab-content">
    <div class="tab-pane active" id="tab-invoice-payment-info">
        <div class="payment-item">
            ...
            @if($serviceObject->booking_type == 'package')
                <div class="item row align-items-center">
                    <div class="col-4">
                        <h5 class="title">{{__('Package')}}</h5>
                    </div>
                    <div class="col-8">
                        <span>{{ get_translate($bookingData['cartData']['package']['title'])}}</span>
                    </div>
                </div>
            @endif
            <div class="item row align-items-center">
            ...
            @if($serviceObject->booking_type == 'date_time')
                <div class="item row align-items-center">
                    <div class="col-4">
