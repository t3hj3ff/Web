                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-7 col-xl-8">
                        <div class="form-left">
                            ...
                            <a href="#become-partner-features" class="explore-now d-none d-lg-inline-block">{{__('Explore Now')}}<i
                                ...
                                <div class="col-12 col-md-8 offset-md-2 col-lg-12 offset-lg-0">
                                    <form id="form-become-a-host" action="{{url('become-a-host')}}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    <label for="become-firstname">{{__('Last Name')}} <span class="text-danger">*</span></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="become-zipcode" class="form-control" name="zipcode"
                                                           autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
