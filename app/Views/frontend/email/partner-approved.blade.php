...
@endphp
    ...
    <html lang="en">
        <head>
            <title>{{__('Your partner registration request has been approved')}}</title>
        </head>
    <body>
    <div class="hh-email-wrapper">
        ...
        <div class="content-email">
            <h2 style="color:#0079c1; margin-bottom: 20px;">{{__('Welcome new partner!')}}</h2>
            <br/>
            <p>{{__('Your partner registration request has been approved. You can login and upload your properties now.')}}</p>
            <br/>
