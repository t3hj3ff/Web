<div class="hh-service-item experience list mb-3" data-plugin="matchHeight">
    <div class="row">
        ...
        <div class="col-12 col-lg-7">
            <div class="detail">
                ...
                @endif
                <a class="title mb-1 mt-1 d-block" href="{{ get_experience_permalink($item->post_id, $item->post_slug) }}">
