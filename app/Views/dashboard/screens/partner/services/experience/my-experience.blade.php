    ...
    <div class="content-page">
        <div class="content">
            ...
            <div class="card-box">
                ...
                <table id="table-my-experience" class="table table-large mb-0 dt-responsive nowrap w-100" data-plugin="datatable"
                       data-paging="false"
                       data-export="on"
                                ...
                                <td class="align-middle">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="media-body">
                                            <h5 class="m-0"><a href="{{ get_experience_permalink($experienceID, $item->post_slug) }}"
                                                               target="_blank">{{ get_translate($item->post_title) }}</a>
                                                <span class="text-muted"> - {{ $experienceID }}</span>
                                            </h5>
                                            <span class="exp d-none">[{{ $experienceID }}] {{ get_translate($item->post_title) }}</span>
                                            @if(!empty($item->durations))
                                                <p class="text-muted mb-0 mt-2 d-none d-md-block">{{ get_translate($item->durations) }}</p>
                                            @endif
                                        </div>
                                    </div>
                                </td>
