        ...
        <div class="content">
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-8 order-lg-4">
                    ...
                    <div class="card relative p-3">
                        <h5>{{__('Payout Information')}}</h5>
                        <form action="{{ dashboard_url('update-your-payout-information') }}" class="form form-action mt-3"
                              method="post">
                            @include('common.loading')
                            <input type="hidden" name="user_id" value="{{ $user_id }}">
                            <input type="hidden" name="user_encrypt" value="{{ hh_encrypt($user_id) }}">
                            <div class="form-group">
                                ...
                                @endphp
                                <select name="payout_payment" id="payout_payment" class="form-control wide" data-plugin="customselect">
                                    <option value="">{{__('---- Select ----')}}</option>
                                    <?php foreach($allPayments as $class){
                                            ...
                                            $id = $class::getID();
                                        ?>
                                        <option value="{{ $id }}" data-icon="<img class='mr-1' width='24' height='24' src='{{$logo}}'>"
                            ...
                            <div class="form-group">
                                ...
                                <p class="text-muted font-italic">{{ __('Enter the payment information that admin can pay for you') }}</p>
                                <textarea name="payout_detail" id="payout-detail" class="form-control">{{$payout_detail}}</textarea>
                            </div>
                            <button type="submit" class="btn btn-success btn-rounded waves-effect waves-light right">
                                <span class="btn-label"><i class="mdi mdi-check-all"></i></span>
                                {{__('Update')}}
