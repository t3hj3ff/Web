    ...
    <div class="content-page">
        <div class="content mt-2">
            ...
            <div class="card-box page-translation">
                ...
                <form action="{{ dashboard_url('update-translate') }}" class="form form-action" method="post" data-encode="true">
                    @include('common.loading')
                    <div class="d-flex mb-3 justify-content-between">
                        <div class="form-inline">
                        <label for="hh-choose-langs" class="mr-2">{{ __('Languages') }}</label>
                        <select id="hh-choose-langs" data-plugin="customselect" class="form-control form-control-sm min-w-200" name="lang" data-url="{{ dashboard_url('translation') }}">
